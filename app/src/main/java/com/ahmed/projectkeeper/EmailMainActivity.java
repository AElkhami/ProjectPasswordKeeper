...
public class EmailMainActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SUB_FAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(EmailMainActivity.this, SubContactActivity.class);
    ...
    public void showSubContact() {
        ...
        mAdapter = new SubContactAdapter(SubModel);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                fromListView = true;
                Intent mIntent = new Intent(EmailMainActivity.this, SubContactActivity.class);
    ...
    public void onDelete() {
        ...
        new AlertDialog.Builder(EmailMainActivity.this)
